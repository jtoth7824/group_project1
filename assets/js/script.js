...
function buildAuthorQueryURL(author) {
  var queryURL =
    "https://api.penguinrandomhouse.com/resources/v2/title/domains/PRH.US/search/views/search-display?";
...
function buildBookTitleQueryURL(isbn) {
  var queryURL =
    "https://api.penguinrandomhouse.com/resources/v2/title/domains/PRH.US/titles/";
...
function buildEventQueryURL(authorid, authoreventisbn) {
  var queryURL =
    "https://api.penguinrandomhouse.com/resources/v2/title/domains/PRH.US/authors/";
...
function buildPickedEventQueryURL(whichEvent) {
  var queryURL =
    "https://api.penguinrandomhouse.com/resources/v2/title/domains/PRH.US/events/";
...
function getBookInfo() {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $("#bookCover").attr(
        "src",
        retrieveCoverArt(response.data.titles[0].isbn)
      );
      displayMovieInfo();
